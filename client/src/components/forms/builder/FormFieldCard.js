      ...
      <div className={`bg-white rounded-xl border ${isEditing ? 'border-blue-500 ring-2 ring-blue-100' : 'border-gray-200 hover:border-gray-300'} transition-all`}>
        ...
        <div className="flex items-center justify-between px-4 py-2 bg-gray-50 border-b border-gray-200 rounded-t-xl">
          <div className="flex items-center gap-2">
            ...
            {field.required && (
              <span className="px-1.5 py-0.5 text-[10px] font-medium text-red-600 bg-red-50 rounded">Required</span>
            )}
          </div>
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              className="w-7 h-7 flex items-center justify-center text-gray-400 hover:text-gray-600 hover:bg-gray-200 rounded"
              title="Edit"
            >
              ✏️
            </button>
            ...
            <button
              ...
              className="w-7 h-7 flex items-center justify-center text-gray-400 hover:text-red-600 hover:bg-red-50 rounded"
              title="Delete"
            >
              🗑️
            </button>
